...
const EducationInfo = ({ userData }) => {
  ...
  const [courseEducationSelected, setCourseEducationSelected] = useState();
            ...
            <Col span={12}>
              ...
              >
                <Select placeholder="ជ្រើសរើស" onChange={(e)=>{
                  setCourseEducationSelected(e)
                  form.resetFields(['level'])
                }}>
                  {Object.keys(EducationData || {}).map((v, i) => {
                    return (
            ...
            <Col span={12}>
              ...
              >
                <Select placeholder="ជ្រើសរើស">
                  {(EducationData[courseEducationSelected]||[]).map((v,i)=>{
                  ...
                  <Option value="វគ្គបណ្ដុះបណ្ដាលរយះពេលវែង និងបន្ត">
                    វគ្គបណ្ដុះបណ្ដាលរយះពេលវែង និងបន្ត
                  </Option>
